...
// chromiumBrowserModel is ONLY a native-browser software test fixture. Chromium's
...
func chromiumBrowserModel(t *testing.T) adminauth.Model {
	...
	root := testfixture.Certificate(t, template, template, &key.PublicKey, key)
	must(t, root.CheckSignatureFrom(root))
	return adminauth.Model{AAGUID: "01020304-0506-0708-0102-030405060708", RootsDER: [][]byte{root.Raw}}
}
