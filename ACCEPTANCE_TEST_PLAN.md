...
Status: **91 specified cases; AUDIT-01 implemented and executed on Windows and Linux; 90 cases remain planned.** This document is the canonical specification; actual results are in docs/phase-2-report.md. Optional-feature tests are deferred only while those features are absent; required MVP platform tests are not optional.
