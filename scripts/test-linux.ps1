...
try {
 ...
 foreach($package in @('cli','controller','pki','adminauth','wire','carrier','control','boottime','workload','clockhealth','connector','localfile','client','enrollment','localipc')){
