...
Actual user-manager execution, process/cgroup limits and enrolled-resource lifecycle passed the separate [systemd guest qualification](arch-user-service.md) on source `804d698e550dd2d51e21f748aafd7874462643c9`. Package checks also verify installed unit bytes/ownership/mode and use `systemd-analyze --user verify`; those checks alone do not prove live service lifecycle or sandbox enforcement.
