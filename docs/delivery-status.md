...
| 5: isolated connector | ADR-006 accepted; generated bounded gRPC carrier, standard inner TLS, separate cancellation watches and loopback integration tests implemented; full checks in progress | Implement service composition, live client connector checks, hosting snapshots, exact workload proxy, controller cancellation/receipts and leases; actual destination socket counters and hostile-load/network tests |
