...
| 6: Linux/Arch client | [Verified development client command](phase-6-client-report.md) adds protected device identity, fresh catalog selection and process-owned application pipes; [ordinary enrollment transport](phase-6-enrollment-report.md) composes real issuer redemption and fresh TLS activation | Encrypted local key/attempt storage and enrollment CLI, platform key store and IPC isolation, desktop/browser resource workflows, Arch packages/services, real user/suspend tests |
