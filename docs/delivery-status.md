...
| 6: Linux/Arch client | [Development resource client](phase-6-client-report.md), [real issuer enrollment transport](phase-6-enrollment-report.md), and [encrypted enrollment command](phase-6-enrollment-cli-report.md) with focused process-restart evidence | Final-source full qualification; encrypted identity integration into resource access, interactive unlocking, platform key store and IPC isolation, desktop/browser workflows, Arch packages/services, real user/suspend tests |
