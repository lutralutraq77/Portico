...
| 5: isolated connector | Development workload forwarding, request-start leases and joined-worker receipts pass full local Windows, hosted Windows/Ubuntu and isolated Linux on 809c0df; hosting-order follow-up 8ecad6d passes focused Windows/Linux checks ([evidence](phase-5-workload-report.md)) | Keep final-source hosted evidence current; supported service composition, OS clock-health providers, complete socket scenarios, physical suspend and hostile-load/network tests |
