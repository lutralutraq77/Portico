...
| 5: isolated connector | ADR-006 accepted; generated bounded gRPC carrier, standard inner TLS and separate cancellation watches implemented; full local Windows checks and NIC-less Linux runtime passed on c77fc37 ([evidence](phase-5-report.md)) | Complete hosted quality qualification; implement service composition, live client connector checks, hosting snapshots, exact workload proxy, controller cancellation/receipts and leases; actual destination socket counters and hostile-load/network tests |
