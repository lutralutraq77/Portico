...
| 5: isolated connector | Carrier/control/native clock checkpoints verified ([control evidence](phase-5-control-report.md)); development [workload runtime](workload-runtime.md) now composes inner TLS, exact TCP proxy, request-start leases and joined-worker receipts, with isolated guest destination tests | Current-source full and hosted qualification; supported service composition, OS clock-health providers, complete socket scenarios, physical suspend and hostile-load/network tests |
