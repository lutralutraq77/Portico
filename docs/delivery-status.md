...
| 6: Linux/Arch client | Development client command adds protected device identity, fresh catalog selection and process-owned application pipes; no supported application client yet | Platform key store and IPC isolation, desktop/browser resource workflows, enrollment tooling, Arch packages/services, real user/suspend tests |
