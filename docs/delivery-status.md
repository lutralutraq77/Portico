...
| 5: isolated connector | Development Linux command, protected local files, native clock health, bounded forwarding/pool and process shutdown/restart pass full Windows, isolated Linux and hosted Windows/Ubuntu on 7ddb5c8 ([evidence](phase-5-connector-command-report.md)) | Keep final-source hosted evidence current; installed service/controller/client packaging, qualified host time services and Windows clock health, complete socket scenarios, physical suspend and hostile-load/network tests |
