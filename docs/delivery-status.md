...
| 6: Linux/Arch client | [Verified development client command](phase-6-client-report.md) adds protected device identity, fresh catalog selection and process-owned application pipes; no supported application client yet | Platform key store and IPC isolation, desktop/browser resource workflows, enrollment tooling, Arch packages/services, real user/suspend tests |
