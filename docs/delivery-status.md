...
| 5: isolated connector | Carrier verified locally on c77fc37 and hosted on f1f190b ([evidence](phase-5-report.md)); control checks, hosting, strict client, bounded cancellation delivery and immutable receipts pass full Windows checks and Linux runtime on 518f139; native clock component added ([control evidence](phase-5-control-report.md)) | Final-source hosted qualification; service composition, exact workload proxy and leases; actual destination socket counters, physical suspend and hostile-load/network tests |
