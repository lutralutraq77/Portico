...
|---|---|---|---|---|
| Q01 | Mature data fabric reuse versus Portico reverse-stream adapter; nested TLS/cancellation/quotas | [ADR-006](ADR-006-connector-transport.md) selects standard TLS over bounded generated gRPC streams after source/dependency comparison with OpenZiti | Prototype design resolved; hostile-load/cancellation/mobile tests and independent review still required | No production transport claim until complete runtime qualification |
